...
export interface ApiDojoDojo extends Struct.CollectionTypeSchema {
  collectionName: 'dojos';
  info: {
    displayName: 'Dojo';
    pluralName: 'dojos';
    singularName: 'dojo';
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    is_sensei: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
